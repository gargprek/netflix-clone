const apikey = "bd7f95ebaa2f61169eab4e2e4a8d6b6e";
...
const apiPaths = {
	...
	searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyCa5v7dMosPS6DG-1LIb4gA-DTdaHprZ6E`
...
function searchMovieTrailer(movieName, iframId) {
	...
	.then(res => {
		...
		const movieItem = elements.closest('.movie-item');
		movieItem.addEventListener('mouseleave', function () {
			div.innerHTML = ''; // Clear the iframe content
		});
	})
